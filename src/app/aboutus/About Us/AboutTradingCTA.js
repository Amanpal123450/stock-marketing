...
export default function AboutTradingCTA() {
  return (
    <section className="flex flex-col items-center justify-center min-h-[60vh] bg-gradient-to-r from-orange-500 to-orange-600 text-white px-6">
      ...
      <p className="text-lg md:text-xl mb-8 text-center max-w-2xl">
       Join thousands of traders who trust Qorva Markets for their trading success. Experience our platform with a free demo account or start trading live today.
      </p>
