...
export default function CommoditiesTradingCTA() {
  return (
...
Ready to Start Commodities Trading?
      </h2>

      {/* Subtext */}
      <p className="text-lg md:text-xl mb-8 text-center max-w-2xl">
Diversify your portfolio with commodities trading and gain exposure to essential global markets.
      </p>
