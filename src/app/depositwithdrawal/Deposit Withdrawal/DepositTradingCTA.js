...
export default function DepositTradingCTA() {
  return (
    <section className="flex flex-col items-center justify-center min-h-[60vh] bg-gradient-to-r from-orange-500 to-orange-600 text-white px-6">
     ...
     Start trading today with instant deposits and same-day withdrawals. Your funds are secure with bank-grade protection.
      </p>
