    ...
    <div className={`p-8 transition-all duration-500 ${
      ...
      <div className="max-w-4xl mx-auto mb-12">
        ...
        <div className="text-center">
          ...
          <h3 className="text-3xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-red-500 mb-6">
            Trade with Confidence.
          </h3>
          <p className={`text-lg ${isDarkMode ? 'text-gray-300' : 'text-gray-600'} max-w-2xl mx-auto`}>
            Join thousands of traders who choose{' '}
            <span className="text-orange-400 font-semibold">Qorva Markets</span>{' '}
      ...
      <div className="max-w-4xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
          {stats.map((stat, index) => (
            <div
              key={index}
              className={`group relative overflow-hidden rounded-xl p-6 transition-all duration-300 hover:scale-105 hover:-translate-y-2 cursor-pointer ${
                isDarkMode 
            ...
            >
              ...
              <div className="relative z-10 text-center">
                <div className={`inline-flex items-center justify-center w-12 h-12 rounded-lg mb-3 ${
                  isDarkMode ? stat.color : 'text-gray-600'
                } bg-white/10`}>
                  {stat.icon}
                </div>
                <div className={`text-2xl md:text-3xl font-bold mb-2 ${
                  isDarkMode ? stat.color : 'text-gray-900'
                }`}>
                  {stat.value}
                </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <button className={`group px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 hover:scale-105 flex items-center gap-2 ${
            isDarkMode 
