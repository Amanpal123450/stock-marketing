...
export default function PartnersTradingCTA() {
  return (
    <section className="flex flex-col items-center justify-center min-h-[60vh] bg-gradient-to-r from-orange-500 to-orange-600 text-white px-6">
      ...
      Join thousands of successful partners earning competitive commissions with Qorva Markets. Start your partnership journey today.
      </p>
