...
export default function ForexTradingCTA() {
  return (
    <section className="flex flex-col items-center justify-center min-h-[60vh] bg-gradient-to-r from-orange-500 to-orange-600 text-white px-6">
      ...
      <p className="text-lg md:text-xl mb-8 text-center max-w-2xl">
        Join thousands of traders who choose Qorva Markets for competitive
        spreads, fast execution, and professional support.
      </p>
